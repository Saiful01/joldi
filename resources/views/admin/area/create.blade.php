        ...
        <div class="col-sm-6">
            <div class="page-title-box">
                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="#">Add New Area</a></li>
                </ol>
            </div>
        </div>
        ...
        <div class="col-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <form class="custom-validation" method="post" action="/admin/area/store" novalidate=""
                          enctype="multipart/form-data">
                        <div class="form-group row">
                            <label for="example-text-input-lg" class="col-sm-2 col-form-label">Area Name</label>
                            <div class="col-sm-10">
                                <input class="form-control form-control-lg" type="text" placeholder="Name"
                                       id="example-text-input-lg" name="area_name" required>
