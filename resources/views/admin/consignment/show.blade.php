                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-1">
                                            <form method="post" action="/same-day/serach">
                                                <button class="btn btn-sm  btn-primary waves-effect waves-light">Same
                                                    Day
                                                </button>
                                        ...
                                        <div class="col-md-1">
                                            <form method="post" action="/next-day/serach">
                                                <button class="btn btn-sm  btn-success waves-effect waves-light">Next
                                                    Day
                                                </button>
                                                <input type="hidden" name="_token" value="{{csrf_token()}}">
                                            </form>
                                            ...
                                            <form class="form-inline" method="post" action="/invoice/serach">
                                                <div class="form-group mx-sm-3 ">
                                                    ...
                                                    <input type="text" class="form-control" id="inputPassword2"
                                                           name="invoice"
                                                           placeholder="Invoice">
                                                    <button type="submit" class="btn btn-info form-group ml-2">Search
                                                    </button>
                                            ...
                                            <form class="form-inline" method="post" action="/status/serach">
                                                <div class="form-group mx-sm-3 ">
                                                    ...
                                                    <select class="form-control" name="status">
                                                        ...
                                                        <option value="delivery_man_assigned">delivery_man_assigned
                                                        </option>
                                    ...
                                    <form method="post" action="/multiple-parcel/deliveryman-assign">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <table class="table mb-0 table-bordered">
                                                        ...
                                                        <thead>
                                                        <tr>
                                                            <th><input class="ml-1" type="checkbox"
                                                                       onclick="toggle(this);"/><br/>
                                                            </th>
                                                            <th>Invoice No</th>
                                                            {{-- <th>D.Chrage</th>--}}
                                                            <th>Amount</th>
                                                        ...
                                                        @foreach($results as $res)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{$res->total_amount}}
                                                                    ...
                                                                    {{$res->payable_amount}}+{{$res->delivery_charge}}
                                                                    +{{$res->cod}}
                                                                    +{{$res->area_charge}}
                                                                ...
                                                                <td>
                                                                    ...
                                                                    @elseif($res->delivery_status=="returned")
                                                                        ...
                                                                        <div
                                                                            class="modal fade receive-modal{{$res->parcel_id}}"
                                                                            tabindex="-1"
                                                                            role="dialog"
                                                                    ...
                                                                    @elseif($res->delivery_status=="partial_delivered")
                                                                        ...
                                                                        <button type="button" class="btn btn-primary"
                                                                                data-toggle="modal"
                                                                                data-target=".receive-modal{{$res->parcel_id}}">
                                                                            Receive
                                                                        </button>
                                        ...
                                        <button name="change"
                                                class="btn btn-danger float-right waves-effect waves-light mr-1"
                                                value="2"
                                                type="submit" onclick="return confirm('are you sure?')">DeliveryMan
                                            Assign
                                        </button>
                                        <button name="change"
                                                class="btn btn-primary float-right waves-effect waves-light mr-1"
                                                value="1" type="submit" onclick="return confirm('are you sure?')">
                                            PickupMan Assign
                                        </button>
