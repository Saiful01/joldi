...
class CreateParcelStatusesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('parcel_statuses', function (Blueprint $table) {
            ...
            $table->string('delivery_status')->default('pending');//pending,pickup_man_assigned,accepted(Qrcode Scan, Payment status done), hub_received, cancelled, delivery_man_assigned, on_the_way (Picked Up By DeliveryMan/ Qrcode Scan), delivered,returned,partial_delivered, returned_to_admin
