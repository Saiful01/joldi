...
class CreateParcelStatusesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('parcel_statuses', function (Blueprint $table) {
            ...
            $table->string('delivery_status')->default('pending');//pending,accepted, cancelled, picked_up_by_delivery_man, on_the_way (Picked Up), delivered,returned,returned_to_merchant, partial_delivered
