...
public class CollectFromHubActivity extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_collect_from_hub);
  ...
  /*  @Override
    ...
    private void collectingStatus(String status) {


        AlertDialog alertDialog = new AlertDialog.Builder(CollectFromHubActivity.this).create();
